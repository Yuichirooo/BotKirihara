...
print "login success kapten"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage =""" J A P A N - T E A M [B O T]

EDITOR : KIRIHARA
line.me/ti/p/~yuichiro-hyakuya
...
"""
KAC=[cl,ki,kk,kc,ks]
mid = cl.getProfile().mid #Kirihara
Amid = ki.getProfile().mid #Yuichiro
Bmid = kk.getProfile().mid #Kurogane
Cmid = kc.getProfile().mid #Ikki
Dmid = ks.getProfile().mid #Kazuto

Bots=[mid,Amid,Bmid,Cmid,Dmid]
admin=["ua88a5459127773417d5496b16463207d","u4beffc9c221ae4764e33523cdebce117","ud77f1d68fbfcd96d23d4e62822af7452","udc343a6d86047813e7c8cbe56aed1371"] 
owner=["ua88a5459127773417d5496b16463207d"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""тerima Kasih Sudah Menambahkan Saya menjadi Teman
Owner : line.me/ti/p/~yuichiro-hyakuya""",
    "lang":"JP",
          ...
          if wait["Protectgr"] == True:
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              ...
              if op.param2 in admin:
                ...
                try:
                  cl.sendText(op.param1,cl.getContact(op.param2).displayName + "Tolong Jangan Buka QR")
                  cl.kickoutFromGroup(op.param1,[op.param2])
                  X = cl.getGroup(op.param1)
                  X.preventJoinByTicket = True
                  cl.updateGroup(X)
                except:
                  random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "Tolong Jangan Buka QR")
        ...
        if op.type == 13:
          if wait["Protectcancl"] == True:
            ...
            if op.param2 in admin:
              ...
              random.choice(KAC).sendText(op.param1, "Maaf ya aku batalkan\nKamu Bukan Admin Sih..\nJadi Aku Cancel😛")
              ...
              if msg.from_ in admin:
                ...
                if txt[1] == "on":
                    ...
                    if jmlh <= 300:
                        ...
                        cl.sendText(msg.to, "Kelebihan batas :v")
    #-----------------=Selesai=------------------
            elif msg.text in ["Kontak bot"]: #Ngirim Semua Kontak Bot
              if msg.from_ in admin:
                msg.contentType = 13
            ...
            elif msg.text in ["Jp cancel","Bot cancel"]:
              if msg.from_ in admin:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Terbuka Kapten")
                else:
                    if wait["lang"] == "JP":
            ...
            elif msg.text in ["Kirihara buka qr","Kirihara open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done Kapten")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Yuichiro buka qr","Yuichiro open qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done Kapten")
                    else:
            ...
            elif msg.text in ["Kuro open qr","Kuro buka qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done Kapten")
                    else:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Tertutup Kapten")
                else:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Can not be used outside the group")
                    else:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Admin Yang bisa Gunain Perintah ini.")
            elif msg.text in ["Kirihara close qr","Kirihara tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Yuichiro tutup qr","Yuichiro close qr"]:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done Kapten")
                    else:
            ...
            elif msg.text in ["Kuro tutup qr","Kuro close qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done Pak")
                    else:
			...
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
                if wait["contact"] == True:
                    ...
                    wait["contact"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cek Mid Share Kontak On")
                    else:
                        cl.sendText(msg.to,"done")
              ...
              if msg.from_ in admin:
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cek Mid Share Kontak Off")
                    else:
                        cl.sendText(msg.to,"done")
                else:
                    wait["contact"] = False
              ...
              if msg.from_ in admin:
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah on kapten")
                    else:
                        cl.sendText(msg.to,"done")
                else:
                    wait["leaveRoom"] = True
              ...
              if msg.from_ in admin:
                if wait["leaveRoom"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah off kapten")
                    else:
                        cl.sendText(msg.to,"done")
                else:
...
#---------------------Sc invite owner ke group------
            elif "Owner Join" in msg.text:
              if msg.from_ in owner:
                gid = msg.text.replace("Owner Join","")
                if gid == "":
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam on/off Start-------------------#            
              ...
              if msg.from_ in admin:
                if wait["clock"] == True:
                    kc.sendText(msg.to,"Bot IKKI jam on")
                else:
                    wait["clock"] = True
                    now2 = datetime.now()
                    ...
                    kc.updateProfile(profile)
                    kc.sendText(msg.to,"Jam Selalu On Kapten")
            elif msg.text in ["Jam off"]:
              if msg.from_ in admin:
                if wait["clock"] == False:
                    kc.sendText(msg.to,"Bot IKKI jam off")
                else:
                    wait["clock"] = False
                    kc.sendText(msg.to,"Jam Sedang Off Kapten")
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to, "Hayo yang sider...\nNanti matanya bintitan loh􀜁􀅔Har Har􏿿")
                try:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "|| Di Read Oleh ||%s\n|| Japan - Team ||\n\n[ Pelaku Sider ]\n%s=> CEK SILENT READER <=\n\n=> Semoga saja yang sider mendapat hidayah :v\n\n=> Amiin Ya Allah\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik Sider dulu Bazeeeng\nBaru Ketik Ciduk\nPEA NJEEER ♪")
    #-----------------------------------------------
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
              ...
              if msg.from_ in owner:
                ...
                G.preventJoinByTicket = False
                cl.updateGroup(G)
                cl.sendText(msg.to,"Japan Team Sedang Dipanggil kapten!")
                invsend = 0
                ...
                G.preventJoinByTicket = True
                cl.updateGroup(G)
                cl.sendText(msg.to,"J A P A N - T E A M !!!")
                ki.sendText(msg.to,"Sudah Lengkap Kapten Yuu !\nSiap diperintah􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                print "Semua Lengkap"
                        
            elif msg.text in ["Siap Join"]:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Japan team out","Kabuur all","Kaboor all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        cl.sendText(msg.to,"Kami diperintah owner untuk out dari grup chat..\nArigatou gozaimas􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                        cl.leaveGroup(msg.to)
                    except:
                        pass
            
            elif msg.text in ["Tinggalkan Cv1"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
            elif msg.text in ["Perintah dilaksanakan"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki.leaveGroup(msg.to)
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in owner:
                print "[Command]Like executed"
                cl.sendText(msg.to,"Kami Siap Like Status Teman Kapten")
                cl.sendText(msg.to,"Kami Siap Like Status Teman\nKami Delay untuk beberapa Detik\nJangan perintah kami dulu sampai kami Selesai Ngelike")
                try:
                  autolike()
                except:
                  pass
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
            ...
            elif "Japan team ratakan" in msg.text:
              if msg.from_ in owner:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Japan team ratakan","")
                    gs = cl.getGroup(msg.to)
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
                    gs = kc.getGroup(msg.to)
                    gs = ks.getGroup(msg.to)
                    random.choice(KAC).sendText(msg.to,"Semua Pasukan siap!")
                    random.choice(KAC).sendText(msg.to,"Bersiap semua!\nSERAAAAAAANG!!")
                    random.choice(KAC).sendText(msg.to,"Jangan Baper yah Kawan")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': mid}
                    random.choice(KAC).sendMessage(msg)
                    targets = []
                        ...
                        for target in targets:
                          ...
                          if target in admin:
                            ...
                            try:
                              ...
                              random.choice(KAC).sendText(msg.to,"Lawan lemah sangat kapten\nGOOD JOB..")
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    random.choice(KAC).sendText(msg.to,"Succes Pak")
                                except:
        ...
        #-------------Fungsi Broadcast Start------------#
            elif "Bcast " in msg.text: #NgeBC Ke semua Group yang di Join :D
              if msg.from_ in owner:
      ...
      #--------------Fungsi Broadcast Finish-----------#
              ...
              if msg.from_ in admin:
                ...
                for i in gids:
                  ...
                  cl.sendText(msg.to,"*******[List Group]*******\n"+ h +"Tergabung Di Grup : "+str(len(gids)))
                
            elif msg.text in ["LG2"]: #Melihat List Group + ID Groupnya (Gunanya Untuk Perintah Owner Join:)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
                h = ""
                for i in gid:
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Japan team all out","Team bye"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
  ...
  #-----------------End-----------
            elif msg.text in ["Jp katakan Hai"]:
                ki.sendText(msg.to,"Hai kalian semua 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Hai kalian semua 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Hai kalian semua 􀜁􀅔Har Har􏿿")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Absen","Absen bot","Absen dulu lah","Respon"]:
              if msg.from_ in admin:
                cl.sendText(msg.to,"👉 Kirihara hadir")
                ki.sendText(msg.to,"👉 Yuichiro hadir")
                kk.sendText(msg.to,"👉 Kurogane hadir")
                kc.sendText(msg.to,"👉 Ikki hadir")
                ks.sendText(msg.to,"👉 Kazuto hadir")
                cl.sendText(msg.to,"Semua Sudah Hadir..\nSiap Protect Group􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
              ...
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "Sabar Kapten...")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'ua88a5459127773417d5496b16463207d'}
              cl.sendText(msg.to,"***********************")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"***********************")
              cl.sendText(msg.to,"Itu Owner Dari Semua Bot Ini 😜")
      ...
      #-------------Fungsi Chat ----------------#
                 ...
                 quote = ['Apaan bazeeng','Ganggu aja sih..\nAing lagi enaena ini ','Ah Bazeeeng','Belaga tampan njeeer','Ada Siapa Disini?','Enaena kuy','Penghuni pada kemana nih?']
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by J A P A N - T E A M👈")
          ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          #ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Kapten Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
          kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          #kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Kapten Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
          kc.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          #kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Kapten Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
          ks.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          #ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Kapten Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
          #cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"J A P A N - T E A M")
          print "Like"
        except:
          pass
      else:
